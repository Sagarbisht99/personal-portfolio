        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              <h3
                className={cn(
                  'text-lg font-bold cursor-pointer hover:text-primary transition-colors duration-200',
              ...
              >
                <svg
                  className={cn(
                    'size-4 transition-transform duration-300 ease-in-out text-neutral-500 hover:text-neutral-700',
